...
class Experience(models.Model):
    ...
    experience1 = RichTextField(null=True,blank=True)
    ...
    experience2 = RichTextField(null=True,blank=True)
    ...
    experience3 = RichTextField(null=True,blank=True)
    ...
    experience4 = RichTextField(null=True,blank=True)
    ...
    experience5 = RichTextField(null=True,blank=True)
    ...
    experience6 = RichTextField(null=True,blank=True)
    ...
    experience7 = RichTextField(null=True,blank=True)
...
class Student(models.Model):
    ...
    program = models.ForeignKey(Program, related_name='program', on_delete=models.CASCADE)
    branch = models.ForeignKey(Branch, on_delete=models.CASCADE)
    year = models.ForeignKey(Year,on_delete=models.CASCADE)
    selected_company = models.ForeignKey(Company, related_name='company', on_delete=models.CASCADE)
